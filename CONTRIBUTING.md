...
Welcome to `jtl_lib` contributor's guide.
...
If you experience bugs or general issues with `jtl_lib`, please have a look
...
You can help improve `jtl_lib` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`jtl_lib` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `jtl_lib`'s files. While this mechanism can
...
```
conda create -n jtl_lib python=3 six virtualenv pytest pytest-cov
conda activate jtl_lib
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/jtl_lib.git
   cd jtl_lib
   ```
...
5. Install [pre-commit]:
   ...
   `jtl_lib` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/jtl_lib
[issue tracker]: https://github.com/<USERNAME>/jtl_lib/issues
